...
public let PVAppGroupId = Bundle.main.infoDictionary?["APP_GROUP_IDENTIFIER"] as? String ?? "group.lionking.provenance"
...
public let UbiquityIdentityTokenKey = (Bundle.main.bundleIdentifier ?? "lionking.provenance-emu.provenance")  + ".UbiquityIdentityToken"
